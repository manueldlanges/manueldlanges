			...
			<?php if(!empty($sentences)): ?>
					<strong><?php echo e(ucwords($keyword)); ?></strong> - <?php echo e(@array_pop($sentences)); ?> <?php echo e(@array_pop($sentences)); ?> <?php echo e(@array_pop($sentences)); ?> <?php echo e(@array_pop($sentences)); ?> <br>
						<?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if(data_exists($r)): ?>
          						<h2 style="font-weight:normal;"><a href="<?php echo e(image_url($r)); ?>"><?php echo e($r); ?></a></h2>
          					<?php endif; ?>
...
<?php $__env->startSection('content'); ?>
	...
	<?php $__currentLoopData = collect($images)->shuffle()->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunked): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
